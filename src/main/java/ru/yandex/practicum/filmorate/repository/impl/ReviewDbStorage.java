...
public class ReviewDbStorage extends BaseDbStorage implements ReviewStorage {
    ...
    public Review createReview(Review review) {
        ...
        jdbc.update(connection -> {
            PreparedStatement stmt = connection.prepareStatement(INSERT_REVIEW, Statement.RETURN_GENERATED_KEYS);
    ...
    public Collection<Review> getReviewsByFilmId(Long filmId, int count) {
        List<ReviewDto> reviews = jdbc.query(SELECT_REVIEWS_BY_FILM_ID, new ReviewRowMapper(), filmId, count);
    ...
    public Review updateReview(Review review) {
        ...
        Integer useful = jdbc.queryForObject(SELECT_RATING_OF_REVIEW, Integer.class, review.getReviewId());
